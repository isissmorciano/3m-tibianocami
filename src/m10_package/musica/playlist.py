...
Playlist = dict[str, str | list[dict]]


def crea_playlist(nome: str) -> Playlist:
    """
...
def aggiungi_canzone(playlist: Playlist, canzone: dict) -> None:
    """Aggiunge una canzone alla playlist."""
    playlist["canzoni"].append(canzone)


def rimuovi_canzone(playlist: Playlist, indice: int) -> None:
